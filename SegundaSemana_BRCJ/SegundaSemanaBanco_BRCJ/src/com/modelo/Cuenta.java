...
public class Cuenta {
	...
	// En el paquete com.modelo guardamos información de los objetos o entidades a
	// los que queremos acceder
	// En este ejemplo necestiamos crear varias cuentas de usuarios y las
	// agregaremos a un HashMap para
